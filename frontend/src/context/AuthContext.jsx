...
const TR = {
  fr: {
    ...
    nav_mes_depenses:'Mes dépenses', nav_validation:'Budgets à valider', nav_depenses_valider:'Dépenses à valider',
  ...
  en: {
    ...
    nav_mes_depenses:'My Expenses', nav_validation:'Budgets to Validate', nav_depenses_valider:'Expenses to Validate',
